...
| [BACKLOG-015](logs/backlog/BACKLOG-015.json) | 2026-05-25 | missing-mcp | P1 | reporting / A2A2H human interface | Outbound email status updates to John at john@husband.llc on a regular cadence and major events | cadence_runner_ready_pending_api_key |
| [BACKLOG-014](logs/backlog/BACKLOG-014.json) | 2026-05-25 | upstream-pr-needed | P0 | A2A2H PWA / notifications and background delivery | Make PWA deliver CTO replies while backgrounded so John can context-switch without missing messages | open_visible_ui_pending_john_verification |
| [BACKLOG-016](logs/backlog/BACKLOG-016.json) | 2026-05-26 | upstream-pr-needed | P0 | A2A2H PWA / inter-hemisphere transparency and auditability | Visible inter-hemisphere coordination transcript or audit view in the PWA | open_visible_ui_pending_john_verification |
| [BACKLOG-017](logs/backlog/BACKLOG-017.json) | 2026-05-26 | feature | P0 | A2A2H PWA / chat history persistence and review | Durable, human-readable chat log export John can review at any time without needing the PWA in the foreground | open_visible_ui_pending_john_verification |
...
| BACKLOG-003 | 2026-05-27 | security | Thorough multi-layer security audit of the public CTO repo and the live CTO deployment | Resolved 2026-05-27: audit umbrella complete; remaining remediation is split into BACKLOG-005/006/007/010/011/012. Evidence: sanitized full-history gitleaks/TruffleHog artifacts, live exposure baseline, scanner fail-closed verification, source/security gates, dependency scan gate, Dependabot validation, and logs/security/BACKLOG-003-security-audit-closure-2026-05-27T2026Z.md. |
...
| BACKLOG-008 | 2026-05-27 | security | Quarantine or retire public clone candidates immediately after validation windows | Resolved 2026-05-27: residual failed candidate 132825157 is absent; added guarded clone-candidate watchdog and wired scripts/install.sh to preserve evidence and request deletion automatically when a fresh candidate fails before promotion. Evidence: scripts/security/clone-candidate-watchdog.py, scripts/install.sh, tests/test_clone_candidate_watchdog.py, tests/test_install_wrapper_candidate_retirement.py, logs/security/BACKLOG-008-install-wrapper-autoretire-2026-05-27T2015Z.md. |
...
| BACKLOG-019 | 2026-05-27 | upstream-pr-needed | Visible failure reporting whenever PWA chat delivery workers, agent routes, or coordinated handoffs are stuck or crash | Resolved 2026-05-27: in-process PWA chat workers now have visible crash, timeout/failure, unauthorized/token-mismatch, and stale-pending watchdog system_events; regression coverage verifies pwa_chat_worker_stuck emits once. A2A2H port completed in the same tick. Evidence: services/pwa/backend/server.py, tests/test_pwa_routing.py, logs/repairs/BACKLOG-019-stale-worker-watchdog-2026-05-27T1245Z.md. |
