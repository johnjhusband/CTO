...
class PwaRoutingTests(unittest.TestCase):
    ...
    def test_manifest_icons_exist_and_are_cached_by_service_worker(self):
        ...
        self.assertIn('const SHELL_CACHE = "cto-shell-v20"', service_worker)
    ...
    def test_frontend_has_visible_a2a_coordination_toggle(self):
        ...
        self.assertIn("Updated 2026-05-27 11:45 UTC · shell v19", index_html)
        ...
        self.assertIn(".release-notes", style_css)
        self.assertIn(".app-version", style_css)
        self.assertIn(".feature-help", style_css)
