# BACKLOG-006 safe credential/security gates — 2026-05-27T1010Z

- A2A2H per-tick check: clean; `git log 27abb1203d2a13253e8c1b7e9658518d77794236..HEAD -- services/pwa services/hermes_a2a_sidecar services/a2a_delegate scripts/cache-keepalive.sh services/chat/db.py` returned no commits.
- Hermes provider circuit: open (`agent_incomplete_provider_NoneType`); no semantic Hermes delegation attempted this tick.
- Gate command: `bash scripts/security/run-safe-security-gates.sh`
- Result: passed (exit 0)
- Scope: non-destructive verification only; no credentials were read, printed, rotated, revoked, or rewritten in history.

## Sanitized output

```text
== secret [REDACTED] guard ==
Secret [REDACTED] guard passed: scanned 393 source-visible files.

== operational secret [REDACTED] check ==
Operational secret [REDACTED] check passed: scanned 248 file(s) plus chat.db; no unredacted markers found.

== install secret-[REDACTED] guard ==
Install secret-[REDACTED] guard passed: checked scripts/install.sh metadata only.
...
- HETZNER_API_TOKEN: [REDACTED]
- GITHUB_TOKEN: [REDACTED]
- HERMES_API_SERVER_KEY: [REDACTED]
- HERMES_A2A_TOKEN: [REDACTED]
- OPENAI_API_KEY: [REDACTED]
- PWA_AUTH_TOKEN: [REDACTED]

Optional/retired credential names to reconcile during rotation window:
- CTO_EMAIL_SMTP_PASSWORD: [REDACTED]
- GOOGLE_ACCOUNT_PASSWORD_[REDACTED] present_nonempty
...
test_does_not_report_secret_[REDACTED] (tests.test_redact_operational_secrets.RedactOperationalSecretsTests.test_does_not_report_secret_[REDACTED] ... ok
...
test_redacts_runtime_token_[REDACTED] (tests.test_redact_operational_secrets.RedactOperationalSecretsTests.test_redacts_runtime_token_[REDACTED] ... ok
...
test_access_log_redacts_legacy_query_token [REDACTED] ... ok
test_api_query_token_[REDACTED] (tests.test_pwa_routing.PwaAccessControlTests.test_api_query_token_[REDACTED] ... ok
test_auth_rejects_bare_url_without_cookie [REDACTED] ... ok
test_legacy_stream_query_token_[REDACTED] (tests.test_pwa_routing.PwaAccessControlTests.test_legacy_stream_query_token_[REDACTED] ... ok
test_legacy_stream_query_token_[REDACTED] (tests.test_pwa_routing.PwaAccessControlTests.test_legacy_stream_query_token_[REDACTED] ... ok
test_non_production_without_auth_token_[REDACTED] (tests.test_pwa_routing.PwaAccessControlTests.test_non_production_without_auth_token_[REDACTED] ... ok
test_previous_pwa_token_[REDACTED] (tests.test_pwa_routing.PwaAccessControlTests.test_previous_pwa_token_[REDACTED] ... ok
test_previous_pwa_token_[REDACTED] (tests.test_pwa_routing.PwaAccessControlTests.test_previous_pwa_token_[REDACTED] ... ok
test_previous_pwa_token_[REDACTED] (tests.test_pwa_routing.PwaAccessControlTests.test_previous_pwa_token_[REDACTED] ... ok
test_production_without_auth_token_[REDACTED] (tests.test_pwa_routing.PwaAccessControlTests.test_production_without_auth_token_[REDACTED] ... ok
test_pwa_shell_is_not_public_when_auth_token_[REDACTED] (tests.test_pwa_routing.PwaAccessControlTests.test_pwa_shell_is_not_public_when_auth_token_[REDACTED] ... ok
test_session_cookie_[REDACTED] (tests.test_pwa_routing.PwaAccessControlTests.test_session_cookie_[REDACTED] ... ok
test_session_cookie_[REDACTED] (tests.test_pwa_routing.PwaAccessControlTests.test_session_cookie_[REDACTED] ... ok
...
test_push_without_vapid_key_[REDACTED] (tests.test_pwa_routing.PwaPushNotificationTests.test_push_without_vapid_key_[REDACTED] ... ok
...
test_push_device_status_summary_is_bounded_and_non_secret [REDACTED] ... ok
...
test_voice_device_status_summary_is_bounded_and_non_secret [REDACTED] ... ok
