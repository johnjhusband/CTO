...
- Circuit state: known provider-side agent_incomplete outage; semantic Hermes delegation paused for another 2058s after 3 consecutive failures (adaptive cooldown 2700s)
