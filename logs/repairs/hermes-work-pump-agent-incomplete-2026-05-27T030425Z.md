...
- Timestamp: 2026-05-27T03:04:13Z
...
- Recovery attempt: recovery restart skipped; cooldown active for another 2695s
- Secret handling: no request headers, bearer tokens, environment values, or raw tool traces recorded.

## Sanitized error preview

HTTP 502: {"task_id": "hermes-work-pump-1779851062-retry2", "status": "error", "error": "Hermes HTTP 502: {\"error\": {\"message\": \"'NoneType' object is not iterable\", \"type\": \"server_error\", \"param\": null, \"code\": \"agent_incomplete\", \"hermes\": {\"completed\": false, \"partial\": false, \"failed\": true}}}"}
